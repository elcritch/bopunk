...
class FirmwareTableModel(QtCore.QAbstractTableModel):
    """
    This class creates the model for displaying the firmware list.
    It should be used in conjuction with a QTableView.
    """
    ...
    def columnCount(self, parent):
        """
        Returns number of columns for model using the passed in array of
        dict keys to resize use insert/remove Column/Rows
        """
    ...
    def headerData(self, section, orientation, role):
        """
        Returns the names for the headers. We also use the myheader data
